...
### [Learning from Past Prices: Evidence from the UK Housing Market](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6163447)

Imperfect knowledge of how information propagates through a market can amplify price responses under social learning. I study this mechanism in the UK housing market using regular, plausibly exogenous shocks to sellers' public information. I exploit the UK Land Registry's monthly publication of transaction prices, introduced in March 2012, and link listings from a large online platform to recently completed comparable sales. Publication increases the sensitivity of asking prices to transactions, and the marginal effect of a given sale rises with the order of subsequent matched listings. This pattern is difficult to reconcile with Bayesian updating under redundant signals and is consistent with redundancy neglect. Sale prices exhibit near one-for-one pass-through of the amplified quote component, with limited offset through listingto-sale discounts or time on market. The findings provide micro-level evidence for belief-based housing price dynamics and disclosure policy.
